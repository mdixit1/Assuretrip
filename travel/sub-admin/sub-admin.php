    ...
    <div class="fulldv subcate_sect">
      ...
      <div class="fulldv category-maindv">
        <div class="see-12 topbox">
            <input type="button" value="Submit" class="btn-blue" onClick="addactivity()">
        </div>
    	<?php
        	...
        	<div class="overlaydv-in">
            	<div class="overlaydv-inner">
                	<div class="activtiyadd">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <p>Name</p>
                            <input type="text" name="nsbname" required/>
                            <p>Username</p>
                            <input type="text" name="nusrname" required/>
                            <p>Password</p>
                            <input type="password" name="nsbpss" required>
				 ...
				 ?>   
                    <tr>
                        ...
                        <td style="text-align:center;">
                        	<a href="activity.php?edit=<?php echo $allct['subadmin_id']; ?>" onClick="editactivit()">
                                <span class="catedit"> <i class="fa fa-edit"></i> </span>
                            </a>
                        </td>
                        <td style="text-align:center;">
                            <a href="activity.php?del=<?php echo $allct['subadmin_id']; ?>">
