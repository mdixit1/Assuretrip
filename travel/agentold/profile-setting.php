    ...
    <div class="col-md-12 p0 rightsidebar">
        ...
        <div class="fulldv prfile_sect">
        	<div class="col-md-12 prodv">
            	<div class="prifile_mg_dv"><img src="images/user.jpg" alt=""/></div>
                <h3><?php echo $st['agent_company']; ?></h3>
                <p style="color:#333; font-size:13px;">Expert in Himachal,Kerala Destinations</p>
            </div>
            
        </div>
        <div class="fulldv prosetting">
        	<h4>Contact Information <a href="<?php echo $url; ?>agent/profile-edit">Edit</a></h4>
            <ul>
                <li>
        ...
        <div class="fulldv prosetting" style="border-top:1px solid #e9e9e9;">
        	<h4>Default T&C <a href="<?php echo $url; ?>agent/terms-condition-edit">Edit</a></h4>
            <ul class="terms">
               <li><?php echo $st['term_condition']; ?></li>
            </ul>
        </div>
