    ...
    <div class="col-md-12 p0 rightsidebar">
        ...
        <div class="fulldv">
        	<div class="fulldv notifi_cat allnoti">
                ...
                <?php
					$show_tlead = $db->prepare("SELECT ld.lead_uniq,tl.confirm_status,tl.transfer_desc,tl.lstart_date FROM lead_transfer tl JOIN leads ld ON ld.leads_id=tl.traf_leadid WHERE tl.traf_agid=:agid ORDER BY tl.transfer_id DESC LIMIT $start, $perpage");
