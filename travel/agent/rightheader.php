<div class="col-md-12 rightsidebar_top1">
    <div class="rightlogo"><a href="<?php echo $url; ?>/agent"><img src="<?php echo $url; ?>/images/logonew.png" alt=""/></a></div>
    ...
    <div class="menuright1">
        <ul>
            ...
            <li class="backul">
                <a href="<?php echo $url; ?>agent/calendar"><i class="fa fa-calendar"></i></a>
                <ul>
                    <li><span></span><a href="#">Calendar</a></li>
                </ul>
            </li>
            <li class="backul">
                <a href="<?php echo $url; ?>agent/view_report"><i class="fa fa-bar-chart"></i></a>
                <ul>
            ...
            <li class="backul"><a href="<?php echo $url; ?>agent/lead_transfer"><i class="fa fa-bell">(<?php echo $cntnotf; ?>)</i></a>
            	<div class="notification_maindvv">
                    ...
                    <div class="fulldv notifi_cat">
                    	<table>
                        <?php
							$show_tlead = $db->prepare("SELECT ld.lead_uniq,tl.confirm_status,tl.transfer_desc FROM lead_transfer tl JOIN leads ld ON ld.leads_id=tl.traf_leadid WHERE tl.traf_agid=:agid ORDER BY tl.transfer_id DESC LIMIT 0,5");
						...
						?>
                            ...
                            <?php } ?>    
                            	<td>
                                    ...
                                    <p><a href="<?php echo $url; ?>agent/requested_trips/<?php echo $tl['lead_uniq']; ?>">See comment</a> <a href="<?php echo $url; ?>agent/requested_trips/<?php echo $tl['lead_uniq']; ?>">Reply</a></p>
                                </td>
